...
export const LoginPage = () => {
  ...
  return (
    <div className="bg-dark text-white min-vh-100 d-flex flex-column">
      ...
      {/* Login Title */}
      <h1 className="mt-5 text-center" style={{ marginTop: '50px' }}>Sign in</h1>

      {/* Login Form */}
      <form className="col-3 mt-4 px-3 mx-auto" style={{ maxWidth: '600px', marginTop: '60px' }} onSubmit={handleSubmit}>
        {/* Username Field */}
        <InputField
          label="Username"
          type="text"
